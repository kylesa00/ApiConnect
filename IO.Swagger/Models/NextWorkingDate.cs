...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class NextWorkingDate : IEquatable<NextWorkingDate>
    { 
        /// <summary>
        /// Next working date of the given branch
        /// </summary>
        /// <value>Next working date of the given branch</value>
        [DataMember(Name="nextWorkingDate")]
        public DateTime? _NextWorkingDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NextWorkingDate {\n");
            sb.Append("  _NextWorkingDate: ").Append(_NextWorkingDate).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((NextWorkingDate)obj);
        }

        /// <summary>
        /// Returns true if NextWorkingDate instances are equal
        /// </summary>
        /// <param name="other">Instance of NextWorkingDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NextWorkingDate other)
        {
            ...
            return 
                (
                    _NextWorkingDate == other._NextWorkingDate ||
                    _NextWorkingDate != null &&
                    _NextWorkingDate.Equals(other._NextWorkingDate)
                ) && 
                (
                    Links == other.Links ||
                    Links != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (_NextWorkingDate != null)
                    hashCode = hashCode * 59 + _NextWorkingDate.GetHashCode();
                    if (Links != null)
        ...
        public static bool operator ==(NextWorkingDate left, NextWorkingDate right)
        {
