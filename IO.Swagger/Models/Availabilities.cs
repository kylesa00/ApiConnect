...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Availabilities : IEquatable<Availabilities>
    { 
        /// <summary>
        /// List of availabilities.
        /// </summary>
        /// <value>List of availabilities.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Availabilities: ").Append(_Availabilities).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Availabilities)obj);
        }

        /// <summary>
        /// Returns true if Availabilities instances are equal
        /// </summary>
        /// <param name="other">Instance of Availabilities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Availabilities other)
        {
            ...
            return 
                (
                    _Availabilities == other._Availabilities ||
                    _Availabilities != null &&
                    _Availabilities.SequenceEqual(other._Availabilities)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + _Availabilities.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(Availabilities left, Availabilities right)
        {
