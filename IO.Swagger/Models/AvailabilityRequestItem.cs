...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AvailabilityRequestItem : IEquatable<AvailabilityRequestItem>
    { 
        /// <summary>
        /// The id of the article to be checked for availability.
        /// </summary>
        /// <value>The id of the article to be checked for availability.</value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AvailabilityRequestItem {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AvailabilityRequestItem)obj);
        }

        /// <summary>
        /// Returns true if AvailabilityRequestItem instances are equal
        /// </summary>
        /// <param name="other">Instance of AvailabilityRequestItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AvailabilityRequestItem other)
        {
        ...
        public static bool operator ==(AvailabilityRequestItem left, AvailabilityRequestItem right)
        {
