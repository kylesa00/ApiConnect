...
{ 
    ...
    { 
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Orders: ").Append(_Orders).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Orders)obj);
        }
        ...
        public bool Equals(Orders other)
        {
            ...
            return 
                (
                    ...
                    _Orders != null &&
                    _Orders.SequenceEqual(other._Orders)
                ) && 
                (
                    Links == other.Links ||
                    Links != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (_Orders != null)
                    hashCode = hashCode * 59 + _Orders.GetHashCode();
                    if (Links != null)
