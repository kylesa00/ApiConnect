...
{ 
    ...
    {
        /// <summary>
        /// The list of customers details.
        /// </summary>
        /// <value>The list of customers details.</value>
        [Required]
        [DataMember(Name="customers")]
        public List<CustomerDetails> _Customers { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Customers)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (_Customers != null)
                    hashCode = hashCode * 59 + _Customers.GetHashCode();
